...
import (
	...
	"github.com/dudebing99/go-ethereum/crypto/signify"
	"github.com/dudebing99/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/dudebing99/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/dudebing99/go-ethereum/internal/version.gitDate="+env.Date)
	}
